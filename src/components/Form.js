      ...
      <form onSubmit={this.handleSubmit}>
        <div className="row">
          ...
          <select value={this.state.lang} onChange={this.handleChange2} className="dpdown">
            ...
            <div className="col-md-4">
                <textarea placeholder="Enter Input" value={this.state.ip} onChange={this.handleChange1} className="form-control" rows="12" cols="70"/>
                <textarea placeholder="Output" readOnly={false} value={this.state.out}   className="form-control" rows="12" cols="70"/>
            </div>
